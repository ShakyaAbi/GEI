  ...
  const milestones = [
    {
      ...
      description:
        "Our journey started with a livelihood and healthcare capacity project in Nuwakot district.",
    ...
    },
    {
      ...
      description:
        "Established a policlinic and launched a goat raising livelihood project in Nepal. Supported hospital construction in Kenya.",
    ...
    },
    {
      ...
      description:
        "Healthcare capacity building in Humla district. Master training in collaboration with the National Health Training Center Nepal in Maternal Neonatal Care.",
    ...
    },
    {
      ...
      description:
        "Completed 13 birthing centers in Humla. Trained 100+ staff.",
    ...
    },
    {
      ...
      description:
        "Redesigned training curricula in Helping Babies Breathe and Helping Mothers Survive. Established Master training courses throughout Nepal.",
    ...
    },
    {
      ...
      description:
        "Investigated micro and macronutrient deficiencies in several districts. Described micro- and macroeconomics impact on health and outcomes. Post-pandemic project evaluations revealed sustainability challenges in many aspects.",
    ...
    },
    {
      ...
      description:
        "GEI formally established as a not-for-profit operating Foundation in the US. Identified integrated community development as preferred strategy combining health care development, economic growth, and environmental preservation as cornerstones based on science and responsible business.",
    ...
    },
    {
      ...
      description:
        "Project collaboration with Dhulikel Hospital: low cost water treatment plant. Achham and Bajura: Integrated community development project.",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 relative">
          <div className="text-center reveal">
            ...
            <p className="text-xl lg:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed font-inter">
              Transforming communities and environments through innovative,
              sustainable solutions that create lasting positive impact across
              the globe.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-8 lg:p-12 border border-blue-100 reveal">
              ...
              <p className="text-gray-700 leading-relaxed text-lg font-inter">
                We believe in a future where economic progress, human health,
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed text-lg font-inter">
                At GEI, our mission is to build resilient, thriving communities
                by advancing environmental sustainability, equitable healthcare,
                and economic opportunity. We empower individuals through green
                job creation, support community health initiatives, and drive
                forward innovative research that fosters a just and sustainable
                future. Guided by a deep commitment to environmental stewardship
                and social equity, we work collaboratively with local
                stakeholders to create lasting impact for people and the planet.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-10">
          <div className="text-center mb-16 reveal">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-inter">
              From humble beginnings to global impact - the story of GEI's
              growth, evolution, and unwavering commitment to environmental
              sustainability.
            </p>
          </div>
                ...
                .map((member) => (
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center p-6 sm:p-8 w-full">
                      <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-1 font-playfair text-center">
                        {member.name}
                      </h3>
                      <p className="text-blue-600 font-semibold mb-3 text-center text-sm sm:text-base font-inter">
                        {member.title}
                      </p>
                      <a
                        ...
                        className={`inline-flex items-center justify-center px-3 py-2 mt-2 rounded-full font-semibold transition-colors ${
                          member.linkedin
      ...
      <section className="py-24 bg-gradient-to-br from-blue-500 to-blue-800 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-10 text-center text-white relative reveal">
          ...
          <p className="text-xl text-blue-100 mb-8 leading-relaxed font-inter">
            Be part of the solution. Whether you're a researcher, policy maker,
            or passionate individual, there are many ways to contribute to our
            global environmental mission.
          </p>
