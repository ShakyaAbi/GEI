...
3. **Skills upgrading for health workers**
   ...
   - 500+ community health volunteers trained (Accham/Bajura); Nuwakot pending (2025)`,
    ...
    const facultyMembers = [
      { name: 'Spencer Crocker MS', title: 'Founder and President', orderIndex: 0 },
      { name: 'Bernhard Fassl MD', title: 'Chief Operating Officer', orderIndex: 1 },
      { name: 'Allison Judkins MD', title: 'Director: Research and Maternal child health', orderIndex: 2 },
      { name: 'Suyog, MBA', title: 'GEI business development', orderIndex: 3 },
      { name: 'Bibek Lamicchane MPH/MPA', title: 'Director of operations GEI Asia', orderIndex: 4 },
      { name: 'Ranjan Dhungana MPH', title: 'Project Consultant', orderIndex: 5 },
      { name: 'Rabin Dhital BPH', title: 'Monitoring, Evaluation, Accountability and Learning (MEAL) Officer', orderIndex: 6 },
      { name: 'Leela Khanal MS', title: 'Project consultant.', orderIndex: 7 },
      { name: 'Sarala Sharma, MN', title: 'Project consultant', orderIndex: 8 },
      { name: 'Shreya Lohani', title: 'Field supervisor-Health project', orderIndex: 9 },
      { name: 'Priyanka Padhyay', title: 'Field supervisor-Health project', orderIndex: 10 },
      { name: 'Paribesh Bidari, MBA', title: 'Research, Data and Communications Consultant/Officer', orderIndex: 11 },
      { name: 'Vaskar Sapkota MPH', title: 'Project Coordinator-DH', orderIndex: 12 },
      { name: 'Padam', title: 'Field Supervisor-Agriculture Project', orderIndex: 13 },
      { name: 'Santosh Rawal', title: 'Field Supervisor-Health Project', orderIndex: 14 },
  
      { name: 'Kishor Rawal BPH', title: 'District Coordinator', orderIndex: 15 },
      { name: 'Deepa Pudasaini', title: 'Field Supervisor-Health  Project', orderIndex: 16 },
      { name: 'Ramu GC', title: 'Finance Manager', orderIndex: 17 },
      { name: 'Priya Thapa RanaMagar', title: 'Support Staff', orderIndex: 18 },
    ];
