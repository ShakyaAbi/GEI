...
3. **Skills upgrading for health workers**
   ...
   - 500+ community health volunteers trained (Accham/Bajura); Nuwakot pending (2025)`,
    ...
    const facultyMembers = [
      { name: 'Spencer Crocker MS', title: 'Founder and President', image: '/uploads/faculty/spencer-crocker.jpg', linkedin_url: '', orderIndex: 1 },
      { name: 'Bernhard Fassl MD', title: 'Chief Operating Officer', image: '/uploads/faculty/bernhard-fassl.jpg', linkedin_url: '', orderIndex: 2 },
      { name: 'Allison Judkins MD', title: 'Director: Research and Maternal child health', image: '/uploads/faculty/allison-judkins.jpg', linkedin_url: '', orderIndex: 3 },
      { name: 'Bibek Lamicchane MPH', title: 'Director of operations GEI Asia', image: '/uploads/faculty/bibek-lamicchane.jpg', linkedin_url: '', orderIndex: 4 },
      { name: 'Suyog, MBA', title: 'GEI business development', image: '/uploads/faculty/suyog.jpg', linkedin_url: '', orderIndex: 5 },
      { name: 'Leela Khanal MS', title: 'Project consultant.', image: '/uploads/faculty/leela-khanal.jpg', linkedin_url: '', orderIndex: 6 },
      { name: 'Shreya Lohani', title: 'Field supervisor-Health project', image: '/uploads/faculty/shreya-lohani.jpg', linkedin_url: '', orderIndex: 7 },
      { name: 'Ranjan Dhungana MPH', title: 'Project Consultant', image: '/uploads/faculty/ranjan-dhungana.jpg', linkedin_url: '', orderIndex: 8 },
      { name: 'Rabin Dhital MPH', title: 'Monitoring, Evaluation, Accountability and Learning (MEAL) Officer', image: '/uploads/faculty/rabin-dhital.jpg', linkedin_url: '', orderIndex: 9 },
      { name: 'Sarala Sharma, BSN', title: 'Project consultant', image: '/uploads/faculty/sarala-sharma.jpg', linkedin_url: '', orderIndex: 10 },
      { name: 'Paribesh Bidari, MS', title: 'Research, Data and Communications', image: '/uploads/faculty/paribesh-bidari.jpg', linkedin_url: '', orderIndex: 11 },
      { name: 'Priyanka', title: 'Program officer', image: '/uploads/faculty/priyanka.jpg', linkedin_url: '', orderIndex: 12 },
      { name: 'Vaskar Sapkota MPH', title: 'Project Manager', image: '/uploads/faculty/vaskar-sapkota.jpg', linkedin_url: '', orderIndex: 13 },
      { name: 'Padam', title: 'Field Supervisor-Agriculture Project', image: '/uploads/faculty/padam.jpg', linkedin_url: '', orderIndex: 14 },
      { name: 'Santosh Rawal', title: 'Field Supervisor-Health Project', image: '/uploads/faculty/santosh-rawal.jpg', linkedin_url: '', orderIndex: 15 },
      { name: 'Kishor Rawal BPH', title: 'District Coordinator', image: '/uploads/faculty/kishor-rawal.jpg', linkedin_url: '', orderIndex: 16 },
      { name: 'Deepa Pudasaini', title: 'Field Supervisor-Health  Project', image: '/uploads/faculty/deepa-pudasaini.jpg', linkedin_url: '', orderIndex: 17 },
      { name: 'Ramu GC', title: 'Finance Manager', image: '/uploads/faculty/ramu-gc.jpg', linkedin_url: '', orderIndex: 18 },
      { name: 'Priya Thapa RanaMagar', title: 'Support Staff', image: '/uploads/faculty/priya-thapa.jpg', linkedin_url: '', orderIndex: 19 },
    ];
