  ...
  try {
    ...
    const categories = [
      {
        ...
        description:
          "Research on water and air pollution, waste management, and clean technology innovations for community health and sustainability.",
      },
      {
        name: "Maternal, Neonatal & Child Health",
        slug: "mnch",
        description:
          "Studies on maternal and child health, nutrition, and anemia including safe childbirth, essential newborn care, and health systems strengthening.",
      },
      {
        name: "Inclusive Economic Development",
        slug: "economic-development",
        description:
          "Research on poverty alleviation through sustainable livelihoods, women empowerment, green jobs, and community business development.",
      },
    ];
    ...
    const publications = [
      {
        ...
        abstract:
          "This paper evaluates the deployment and impact of modular water purification systems co-developed by GEI and Dhulikhel Hospital in remote Himalayan communities.",
      ...
      },
      {
        ...
        abstract:
          "This publication presents results from field-based anemia screening and treatment programs led by GEI in Accham, Nuwakot, and Bajura districts.",
      ...
      },
      {
        ...
        abstract:
          "The study explores how GEI's eco-business model, including plastic reuse and compost production, contributes to sustainable livelihoods in Western Nepal.",
      ...
      {
        title:
          "Non-Invasive Anemia Detection for Maternal Health in Resource-Limited Settings",
        abstract:
          "This publication documents GEI's validation and field trials of a non-invasive hemoglobin screening device for pregnant women in high-altitude settings.",
      ...
      {
        title:
          "Climate-Resilient Health Infrastructure: Lessons from the Kolti Hospital Project",
        abstract:
          "GEI's partnership in designing and planning the Kolti Referral Hospital demonstrates how climate-smart health infrastructure can bridge access gaps in remote districts.",
        journal: "International Journal of Health Systems & Climate",
        publicationYear: 2024,
        publicationType: "Case Study",
        doi: "10.1234/gei.2024.005",
        pdfUrl:
          "https://example.com/papers/kolti-climate-resilient-hospital.pdf",
        citations: 14,
        categorySlug: "environmental-innovation",
      },
    ];
    ...
    const programAreas = [
      {
        ...
        description:
          "GEI pioneers clean technologies including water purification, air pollution mitigation, and waste recycling to improve environmental health.",
        seoTitle: "Environmental Innovation | GEI",
        seoDescription:
          "Explore GEI's innovations in water purification, air quality improvement, and sustainable waste management.",
        orderIndex: 1,
      },
      {
        ...
        description:
          "Improving maternal and child health through infrastructure upgrades, anemia management, safe delivery training, and diagnostics innovation.",
        seoTitle: "Maternal & Child Health Programs | GEI",
        seoDescription:
          "Discover GEI's maternal and child health programs, including nutrition, anemia prevention, and newborn care.",
        orderIndex: 2,
      },
      {
        ...
        slug: "economic-development",
        description:
          "Creating community-based green businesses, promoting women-led cooperatives, eco-tourism, and permaculture in underserved regions.",
        seoTitle: "Community Development & Livelihoods | GEI",
        seoDescription:
          "Learn how GEI supports sustainable income generation, permaculture farming, and women's economic empowerment.",
        orderIndex: 3,
      },
    ];
    ...
    for (const area of programAreas) {
      ...
      const existing = await prisma.programArea.findFirst({
        where: {
          OR: [{ slug: area.slug }, { name: area.name }],
        },
      });
      if (existing) {
    ...
    const projects = [
      // I. SUSTAINABLE HEALTH CAPACITY BUILDING ACCHAM and BAJURA
      {
        ...
        description:
          "Implementing sustainable basic health systems strengthening and capacity building in rural Nepal through public-private-academic partnerships.",
        overview: `## Overview
...
Health facilities are now able to provide basic preventive and life-saving care.`,
        ...
        impactMetrics: [
          ...
          "28 health posts upgraded",
          "14 birthing centers functional",
        ],
      ...
      // II. KOLTI HOSPITAL PROJECT
      {
        ...
        description:
          "Upgrading the current Primary Health Center in Kolti to a 50-bed hospital providing emergency surgical, maternity, pediatric and general medical services.",
        overview: `## Overview
...
- Community engagement and planning`,
      ...
      // III. CLEAN WATER & WASTE MANAGEMENT SYSTEMS
      {
        ...
        description:
          "Implementing affordable water filtration and treatment modalities to address water contamination issues in Nepal.",
        overview: `## Overview
...
- Model for scale-up in Nepal and beyond`,
      ...
      // IV. NOVEL ECONOMIC INITIATIVES
      {
        ...
        description:
          "Creating green, sustainable economies using locally available resources and connecting rural economies to markets.",
        overview: `## Background
...
- Community health programs launched`,
      ...
      {
        title:
          "Center for Health, Agrotourism and Community Economic Development",
        description:
          "Building green, sustainable economies in Nepal through integrated community development approaches.",
        overview: `## Background
...
- Community integration and personnel`,
      ...
      // VI. GEI RESEARCH - ANEMIA PREVENTION
      {
        ...
        description:
          "Pilot testing of AI-powered screening tool to detect and manage anemia in Nepal using cast iron cookpots.",
        overview: `## Overview
...
- Immediate policy impact via collaboration with Nepal National Health Research Council`,
        ...
        impactMetrics: [
          "AI screening tool validation",
          "Cast iron cookpot intervention",
      ...
      // VII. HELAMBU LIVELIHOOD PROJECT
      {
        ...
        description:
          "Building economic capacity through social entrepreneurship and sustainable finance programs in Helambu municipality.",
...
- Dairy/ghee production and market access`,
      ...
      // VIII. MATERNAL NEONATAL TRAINING PROGRAM
      {
        ...
        description:
          "Building case management skills among health workers and care capacity in rural health facilities to manage IHE and postpartum hemorrhage.",
...
3. **Skills upgrading for health workers**
   ...
   - 500+ community health volunteers trained (Accham/Bajura); Nuwakot pending (2025)`,
    ...
    console.log(
      `Upserted ${projects.length} comprehensive GEI projects with Markdown support`
    );

    // Add or replace the faculty seeding section:
    const facultyMembers = [
      {
        name: "Spencer Crocker MS",
        title: "Founder and President",
        image: "/uploads/faculty/spencer-crocker.jpg",
        linkedin_url: "",
        orderIndex: 1,
      },
      {
        name: "Bernhard Fassl MD",
        title: "Chief Operating Officer",
        image: "/uploads/faculty/bernhard-fassl.jpg",
        linkedin_url: "",
        orderIndex: 2,
      },
      {
        name: "Allison Judkins MD",
        title: "Director: Research and Maternal child health",
        image: "/uploads/faculty/allison-judkins.jpg",
        linkedin_url: "",
        orderIndex: 3,
      },
      {
        name: "Bibek Lamicchane MPH",
        title: "Director of operations GEI Asia",
        image: "/uploads/faculty/bibek-lamicchane.jpg",
        linkedin_url: "",
        orderIndex: 4,
      },
      {
        name: "Suyog, MBA",
        title: "GEI business development",
        image: "/uploads/faculty/suyog.jpg",
        linkedin_url: "",
        orderIndex: 5,
      },
      {
        name: "Leela Khanal MS",
        title: "Project consultant.",
        image: "/uploads/faculty/leela-khanal.jpg",
        linkedin_url: "",
        orderIndex: 6,
      },
      {
        name: "Shreya Lohani",
        title: "Field supervisor-Health project",
        image: "/uploads/faculty/shreya-lohani.jpg",
        linkedin_url: "",
        orderIndex: 7,
      },
      {
        name: "Ranjan Dhungana MPH",
        title: "Project Consultant",
        image: "/uploads/faculty/ranjan-dhungana.jpg",
        linkedin_url: "",
        orderIndex: 8,
      },
      {
        name: "Rabin Dhital MPH",
        title:
          "Monitoring, Evaluation, Accountability and Learning (MEAL) Officer",
        image: "/uploads/faculty/rabin-dhital.jpg",
        linkedin_url: "",
        orderIndex: 9,
      },
      {
        name: "Sarala Sharma, BSN",
        title: "Project consultant",
        image: "/uploads/faculty/sarala-sharma.jpg",
        linkedin_url: "",
        orderIndex: 10,
      },
      {
        name: "Paribesh Bidari, MS",
        title: "Research, Data and Communications",
        image: "/uploads/faculty/paribesh-bidari.jpg",
        linkedin_url: "",
        orderIndex: 11,
      },
      {
        ...
        image: "/uploads/faculty/priyanka.jpg",
        linkedin_url: "",
        orderIndex: 12,
      },
      {
        name: "Vaskar Sapkota MPH",
        title: "Project Manager",
        image: "/uploads/faculty/vaskar-sapkota.jpg",
        linkedin_url: "",
        orderIndex: 13,
      },
      {
        name: "Padam",
        title: "Field Supervisor-Agriculture Project",
        image: "/uploads/faculty/padam.jpg",
        linkedin_url: "",
        orderIndex: 14,
      },
      {
        name: "Santosh Rawal",
        title: "Field Supervisor-Health Project",
        image: "/uploads/faculty/santosh-rawal.jpg",
        linkedin_url: "",
        orderIndex: 15,
      },
      {
        name: "Kishor Rawal BPH",
        title: "District Coordinator",
        image: "/uploads/faculty/kishor-rawal.jpg",
        linkedin_url: "",
        orderIndex: 16,
      },
      {
        name: "Deepa Pudasaini",
        title: "Field Supervisor-Health  Project",
        image: "/uploads/faculty/deepa-pudasaini.jpg",
        linkedin_url: "",
        orderIndex: 17,
      },
      {
        ...
        image: "/uploads/faculty/ramu-gc.jpg",
        linkedin_url: "",
        orderIndex: 18,
      },
      {
        name: "Priya Thapa RanaMagar",
        title: "Support Staff",
        image: "/uploads/faculty/priya-thapa.jpg",
        linkedin_url: "",
        orderIndex: 19,
      },
    ];
